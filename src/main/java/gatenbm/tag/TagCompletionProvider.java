...
public class TagCompletionProvider implements CompletionProvider
{

	public TagCompletionProvider()
	{
	}
		...
		return new AsyncCompletionTask(new AsyncCompletionQuery()
		{
			...
			protected void query(CompletionResultSet completionResultSet, Document document, int caretOffset)
			{
				...
				for (Tag tag : Tag.VALUES)
					if (tag.filter().startsWith(filter))
						completionResultSet.addItem(new TagCompletionItem(tag, startOffset, caretOffset));
